...
export async function getAllPostsWithSlug(categoryName) {
  const data = await fetchAPI(`
    {
...
export async function getAllPostsForHome(preview, categoryName) {
...
export async function getPostAndMorePosts(slug, preview, previewData, categoryName) {
