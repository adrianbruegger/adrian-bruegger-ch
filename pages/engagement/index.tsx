        ...
        <Layout preview={preview}>
            ...
            <Container>
                <Intro title={"Engagement"}
                    alt={"Dekoratives Bild des Säntis vom Stockberg aus zur Illustration der Engagement Seite von Adrian Brügger"}
                    ...
                    subtitle={"Mein aktuelles Engagement."} text={""} image={"/assets/stockberg.png"} gradient={""} />
